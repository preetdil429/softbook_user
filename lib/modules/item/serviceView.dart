...
import 'package:flutter_softbook/modules/item/serviceCont.dart';
...
class  ItemServiceScreen extends StatelessWidget {
  var controller = Get.put(ItemServiceController());
  @override
  Widget build(BuildContext context) {
    ...
    var child =  Scaffold(
      appBar: AppBar(
        ...
        title: texts("SERVICE",fontSize: SizeConfig.blockSizeVertical*2.5,
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      SizedBox(height: SizeConfig.blockSizeVertical*0.5,),
                      Center(
                        child: texts("Service Details",fontSize: SizeConfig.blockSizeVertical*2.5,
                            textColor: mainColor,fontWeight: FontWeight.w700),
                      ),
                      SizedBox(height: SizeConfig.blockSizeVertical*2,),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: SizeConfig.blockSizeVertical*2,),
                      texts("SAC Code",fontSize: SizeConfig.blockSizeVertical*2.2,textColor: Colors.black,fontWeight: FontWeight.w600),
                      SizedBox(height: SizeConfig.blockSizeVertical*0.5,),
                      Container(
                        width: SizeConfig.blockSizeHorizontal * 95,
                        margin:
