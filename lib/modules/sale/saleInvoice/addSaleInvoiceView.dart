  ...
  Widget build(BuildContext context) {
    ...
    var child =  Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: texts("Add Sale Invoice",fontSize: SizeConfig.blockSizeVertical*2.5,
        ...
        child: Container(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                texts("Customer Name",fontSize: SizeConfig.blockSizeVertical*2.2,textColor: Colors.black,fontWeight: FontWeight.w600),
