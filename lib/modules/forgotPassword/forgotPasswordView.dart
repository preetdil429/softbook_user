...
import 'package:flutter_softbook/modules/forgotPassword/forgotPwdCont.dart';
      ...
      body: Background(
        child: Container(
          child: Column(
            ...
            children: <Widget>[
              SizedBox(height: SizeConfig.blockSizeVertical*8.5,),
              GestureDetector(
                onTap: ()
                {
                  Get.back();
              ...
              Container(
                  ...
                  child: texts("FORGOT \n PASSWORD", textColor:food_color_blue_gradient1,
              ...
              Container(
                ...
                child: RaisedButton(
                  ...
                  child: Container(
                      ...
                      padding: const EdgeInsets.all(0),
                      child: texts("SUBMIT", textColor:Colors.white,
